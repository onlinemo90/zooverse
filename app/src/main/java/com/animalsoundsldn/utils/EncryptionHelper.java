package com.animalsoundsldn.utils;
...
public class EncryptionHelper {
	private static final String encryptionKey = MainApplication.getContext().getString(R.string.encryption_key);
	...
	public static String encrypt(String plainText) {
		return runEncryptionScript(true, plainText);
	}
	
	public static String decrypt(String cipherText) {
		return runEncryptionScript(false, cipherText);
	}
	
	private static String runEncryptionScript(boolean encrypt, String inputText) {
		//Reference: http://old.brionmario.com/mozilla-rhino-javascript-engine/
		
		String scriptFunctionName = encrypt ? "encrypt" : "decrypt";
		Object[] functionParams = new Object[]{inputText, encryptionKey, 256};
		
		//read javaScript logic from file
		String script = null;
		try {
		InputStream externalScript = MainApplication.getContext().getAssets().open("decrypt.js");
